...
class ModalProduct extends Component{
    ...
    render(){
        ...
        return (
            <Modal show={show} onHide={onHide} dialogClassName="modalSizes"
                    ...
                    <Container>
                        <Row className="show-grid">
                            ...
                            <Col xs={12} md={7}>
                                ...
                                <Row className="show-grid">
                                    <Col xs={5} md={12}>
                                        <Card.Text className={"priceStyle"}>{product.price}$</Card.Text>
                                    </Col>
                                    <Col xs={5} md={12}>
                                ...
                                <Row className="show-grid buttons_cart">
                                    <Col xs={5} md={5}>
                                        <Button variant="outline-success" onClick={() => {this.postProductToCart(product._id)}}>
